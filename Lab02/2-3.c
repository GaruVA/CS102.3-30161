...
int main() {
    ...
    When division is done with two integers, integer division occurs, which will cut off any decimal values from the answer if there are any.Which will give us a slight error in the answer.
